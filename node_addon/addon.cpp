...
void InitAll(Local<Object> exports) {
  AWParserWrap::CAWParserWrap::Init(exports);
}
...
#ifdef AW_INTERNAL_MODULE
NODE_MODULE_CONTEXT_AWARE_BUILTIN(aw_node_addon, InitAll)
#else
NODE_MODULE(aw_node_addon, InitAll)
#endif
